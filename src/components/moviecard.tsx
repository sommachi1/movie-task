  ...
  return (
    <section>
      ...
      <div className="Movie_box">
        ...
        <div>
          <img src="../../public/images/herocard1.png" alt="Stranger Things" />
        ...
        <div>
          <img src="../../public/images/herocard2.png" alt="Stranger Things" />
          <div className="movie-info">
            <p className="year">USA, 2016 - Current</p>
            <h3>Bat Man Begins</h3>
            <div className="ratings">
              <div className="imdb">
                <img src="../../public/images/imdb.png" alt="" />
                <p>840/100</p>
        ...
        <div>
          <img src="../../public/images/herocard3.png" alt="Stranger Things" />
          <div className="movie-info">
            <p className="year">USA, 2016 - Current</p>
        ...
        <div>
          <img src="../../public/images/herocard4.png" alt="Stranger Things" />
          <div className="movie-info">
            <p className="year">USA, 2016 - Current</p>
            <h3>Dunkirk</h3>
            <div className="ratings">
